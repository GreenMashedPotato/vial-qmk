...
[_BASE] = LAYOUT(ppppnnnnnnnnn......
    ...
    KC_ENT, KC_COMM,KC_DOT, KC_J,   KC_G,   KC_QUOT,    KC_SCLN,KC_W,   KC_K,   KC_MINS,KC_X,   KC_SLSH,
            KC_LALT,KC_LGUI,KC_ESC, LW_E,   SF_BSPC,    AL_ENT, RS_SPC, RAISE,  _______,_______
),

[_RAISE] = LAYOUT(
    _______,KC_EXLM,KC_AT,  KC_UP,  KC_LCBR,KC_RCBR,    KC_BSLS,KC_7,   KC_8,   KC_9,   KC_ASTR , _______,
    _______,KC_HASH,KC_LEFT,KC_DOWN,KC_RGHT,KC_DLR,     KC_EQL, KC_4,   KC_5,   KC_6,   KC_0 ,    _______,
    _______,KC_LBRC,KC_RBRC,KC_LPRN,KC_RPRN,KC_AMPR,    KC_GRV, KC_1,   KC_2,   KC_3,   KC_PLUS , _______,
            _______,_______,ADDDD,  ADDDD  ,_______,    _______,_______,RAISE, _______, _______
),
[_LOWER] = LAYOUT(
    _______,RESET,  _______,_______,KC_F1,  KC_F2,      KC_F3,  KC_F4,  _______,_______,_______ , _______,
    _______,_______,KC_PSCR,KC_PGUP,KC_F5,  KC_F6,      KC_F7,  KC_F8,  KC_HOME,_______,_______ , _______,
    _______,_______,KC_SLCK,KC_PGDN,KC_F9,  KC_F10,     KC_F11, KC_F12, KC_END, _______,_______ , _______,
            _______,_______,LOWER,  _______,_______,    _______,ADDDD,ADDDD, _______, _______
),
[_ADJUST] = LAYOUT(
    _______,_______,EXPLR,  KC_UP,  PRVTAB, PRVWIN,     NXTWIN, NXTTAB, _______,_______,LCKGUI,  _______,
    _______,TSKMGR, KC_LEFT,KC_DOWN,KC_RGHT,UPTAB,      DNTAB,  KC_ENT, KC_LGUI,_______,CALDL,   _______,
    _______,_______,CLSGUI, _______,CONPST, RESET,      _______,_______,_______,_______,_______, _______,
